  ...
  return (
    <div className='bg-gray-800 py-8 text-white'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div>
            <h2 className='text-2xl font-bold mb-4'>Travel Phuket</h2>
            <p className='mb-4'>you trusted partner for unforgettable travel experience. Explore the World with us</p>
            </div>
            ...
            <form className='flex items-center justify-center mt-8'>
                ...
                <button className='bg-blue-600 text-white px-4 py-2 rounded-r-lg-lg border border-blue-600'>Subscribe</button>
            </form>
        </div>
      </div>
      <div className='flex justify-between mt-8 border-t border-gray-700 pt-4'>
        <p> &copt; 2024 Travel Phuket. All rights reserved.</p>
