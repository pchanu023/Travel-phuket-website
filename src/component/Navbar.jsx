    ...
    <nav className='fixed m-4 top-0 right-0 left-0 shadow-lg z-50 bg-white'>
        ...
        {isOpen && (
            <div className='md:hidden flex space-y-6 py-4 flex-col bg-white  items-center'>
                <Link to="/home" className='px-10 py-2 hover:bg-gray-600 hover:text-white'>Home</Link>
                <Link to="/gallery" className='px-10 py-2 hover:bg-gray-600 hover:text-white'>Gallery</Link>
                <Link to="/contact" className='px-10 py-2 hover:bg-gray-600 hover:text-white'>Contact</Link>
                <Link to="/about" className='px-10 py-2 hover:bg-gray-600 hover:text-white'>About</Link>
                <button className='py-2 px-10 border bg-gray-300'> Login</button>
            </div>
        )}
    </nav>
  )
